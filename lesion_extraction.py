...
def decide_pred_lesion_type(cc_pred, y_pred_multi, y_multi, method, threshold=None):
    ...
    :param y_pred_multi: predicted binary lesion mask
    ...
    if method == 'non_zero':
        ...
        iou_adj = IoU_adjusted_metric(cc_pred=cc_pred, y_pred_multi=y_pred_multi, y_multi=y_multi)['IoUadj']
