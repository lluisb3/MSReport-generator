...
def get_train_options():
    ...
    parser.add_argument('--balance_mask_path', type=str, default=None)
    parser.add_argument('--balance_mask_prefix', type=str, default=None)
    parser.add_argument('--n_balance_classes', type=int, default=0)
...
def get_predict_options(clwml_eval=False):
    parser = argparse.ArgumentParser(description='Get all command line arguments.')
    parser.add_argument('--exp_name', required=True, type=str, help="name of the experiment")
    ...
    parser.add_argument('--n_classes', type=str, default=2,
                        help="number of output dimensions including background")
    parser.add_argument('--model_checkpoint', type=str, required=True, help="path to saved model")
    # tuned parameters
    parser.add_argument('--threshold', type=float, default=0.5,
                        help='Threshold for lesion detection')
    parser.add_argument('--l_min', type=float, default=0,
